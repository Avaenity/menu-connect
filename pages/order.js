		...
		<div className="main-content">
			<div className="container pt-16 px-10">
				...
				<div className="info-bulle flex flex-row mt-4">
					...
					<ul>
						<li className="text-sm text-gray-600">Glissez à gauche pour ajouter un plat</li>
						<li className="text-sm text-gray-600">Glissez à droite pour le retirer </li>
					</ul>
				</div>
				...
				<div className="order-summary mb-8">
					...
					<p className="text-center text-xs text-gray-600 mt-2 leading-snug"><span className="font-semibold">Gardons le contact</span><br/>Pour passer commande, faites appel à votre serveur!</p>
				</div>
			</div>
		</div>
	)
