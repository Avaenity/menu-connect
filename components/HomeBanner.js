export default function HomeBanner({searchOpen, setSearchOpen}) {
    ...
    return (
        <div className={`home-banner relative h-48 i6:h-40 bg-cover bg-cover bg-no-repeat${searchOpen ? ' search-open' : ''}`}>
            <div className="content-container absolute h-full w-full z-1 flex flex-col justify-center content-center">
                <img className="logo-banner w-20 i6:w-16  self-center mb-2" src="/logo.png" />
